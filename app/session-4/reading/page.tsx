...
const data: SessionReadingData = {
  ...
  orientation: "Phase 4 tests whether the product choice can survive contact with people and reality without dissolving into consensus, PM takeover, or retrospective storytelling.",
  units: [
    {
      number: "10",
      ...
      exhibits: [
        {
          ...
          items: [
            ...
            { kicker: "PRODUCT DIRECTION", title: "Own the product decision", copy: "The named owner chooses the direction and accepts its trade-offs.", tone: "highlight" },
        ...
        },
        {
          ...
          kind: "ledger",
          items: [
            { kicker: "DECIDED", title: "Bounded meeting follow-up pilot", copy: "Help Partner A retrieve decisions and identify action owners within a constrained permission model.", tone: "highlight" },
      ...
      exhibits: [
        {
          ...
          implication: { label: "What stayed stable", copy: "The direction remains: help enterprise team leads retrieve decisions and identify action owners after recurring meetings. The sequence, exposure, and governance controls change in response to new delivery evidence." }
        },
        {
          ...
          kind: "ledger",
          items: [
            { kicker: "OUTCOME", title: "Learn whether recording decisions and owners improves follow-up", copy: "The product goal remains owned by the PM." },
  ...
  next: { label: "COURSE COMPLETE · FINAL REVIEW", title: "Explain the evolution of judgment", copy: "Show how the decision changed, which uncertainty remains, and what you would do next. Ask a trusted peer to challenge the reasoning if you can." }
};
