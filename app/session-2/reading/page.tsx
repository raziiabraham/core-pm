...
const data: SessionReadingData = {
  ...
  orientation: "Phase 2 turns the weakest consequential claim from phase 1 into one traceable update—not a larger evidence packet.",
  units: [
    {
      number: "04",
      ...
      prose: [
        "Begin with the weakest consequential claim carried from phase 1. For the shared Noted case, the claim is not that enterprise users like summaries. The claim is that enterprise team leads repeatedly lose decisions, action owners, or context after recurring meetings, causing rework or missed commitments. Different findings could produce different actions, so define those discriminating findings before selecting interviews, behavioral analysis, a usability study, a pilot, or an experiment.",
      ...
      exhibits: [
        {
          ...
          kind: "chain",
          items: [
            { kicker: "01", title: "Decision", copy: "Choose whether Noted should invest in helping enterprise team leads record decisions, assign action owners, and share context after recurring meetings." },
            { kicker: "02", title: "Weak claim", copy: "Enterprise team leads lose decisions, action owners, or context after recurring meetings, causing rework or missed commitments." },
      ...
      exhibits: [
        {
          ...
          items: [
            ...
            { kicker: "MECHANISM", title: "Plausible explanation", copy: "Some recurring meetings end without a recorded decision or assigned action owner, forcing later reconstruction." },
            { kicker: "BELIEF", title: "Current interpretation", copy: "Unassigned action owners are a plausible cause of recap work in the target meetings; missing summaries remain an alternative cause." },
            { kicker: "DECISION", title: "Changed state", copy: "Investigate whether action-owner assignment causes the observed rework before making a product commitment." }
          ],
  ...
  checkpointIntro: "The phase 2 record should reveal how the decision-linked claim shaped the evidence plan, how the evidence changed the belief, and which uncertainty still constrains action.",
  checkpointFields: [
  ...
  next: { label: "PHASE 3 · CHOOSE", title: "Turn the belief into direction", copy: "Use the calibrated belief to choose a strategy, allocate the portfolio, and reprice the technical option." }
};
