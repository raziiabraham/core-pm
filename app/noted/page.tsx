    ...
    <main className="noted-briefing">
      ...
      <section className="noted-hero">
        <div className="noted-hero-copy">
          <p className="noted-kicker">Before lesson 01 · Shared product context</p>
      ...
      <section className="noted-field-note" id="plain-english">
        ...
        <div className="noted-definition">
          ...
          <p>The product therefore sits across three jobs: <b>thinking</b>, <b>producing</b>, and <b>carrying work forward</b>. Phase 1 focuses on the decisions around that system—not on evaluating an isolated AI feature.</p>
        </div>
      </section>
      ...
      <section className="noted-section noted-case-section" id="case">
        <div className="noted-section-heading"><span>Exhibit 4 · Phase 1 case snapshot</span><h2>You join with four signals competing for PM attention.</h2><p>They are deliberately incomplete. The first task is not to solve them all; it is to identify the consequential decision behind each signal and choose which one warrants scarce PM judgment now.</p></div>
        ...
        <div className="noted-question-strip"><span>Question to carry into lesson 01</span><b>Which decision—not which project—deserves scarce PM judgment first?</b></div>
      </section>
      ...
      <section className="noted-section" id="provenance">
        ...
        <div className="noted-provenance">
          ...
          <article className="constructed"><header><span>CONSTRUCTED</span><b>Valid for practice, not market proof</b></header><ul><li>Customer names, interviews, personas, and conversations</li><li>Seeded analytics and all four phase 1 signals</li><li>People, company history, and most narrative context</li></ul></article>
        </div>
      ...
      <section className="noted-section noted-observation" id="walkthrough">
        <div className="noted-section-heading"><span>Before lesson 01 · 15–18 minutes</span><h2>Experience the product once before the case tells you what to see.</h2><p>Use something real enough that the editor and AI have a meaningful job. A blank document titled “test” will teach you almost nothing.</p></div>
      ...
      <section className="noted-section noted-output-section">
        <div className="noted-section-heading"><span>Keep for lesson 01</span><h2>Four lines—brief, specific, and entirely your own.</h2></div>
      ...
      <section className="noted-ready">
        ...
        <h2>You now know enough about Noted to begin making product decisions—not taking a product tour.</h2>
        <div><a className="noted-primary" href="https://wellnoted.dev" target="_blank" rel="noreferrer">Open the product ↗</a><Link className="noted-secondary" href="/session-1/reading#attention">Continue to lesson 01 →</Link></div>
      </section>
