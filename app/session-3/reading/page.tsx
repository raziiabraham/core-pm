...
const data: SessionReadingData = {
  ...
  orientation: "Phase 3 begins where evidence stops: the point at which a PM must turn an incomplete but defensible belief into an explicit direction and set of trade-offs.",
  units: [
    {
      number: "07",
      ...
      prose: [
        "Begin with diagnosis. A diagnosis interprets the evidence into the central tension the product must resolve; it is neither a data summary nor a restatement of the goal. For Noted, the evidence suggests that the valuable enterprise mechanism is not generic meeting summarization. It is reliably recording decisions, assigning action owners, and carrying required context into follow-up after decision-heavy meetings. Activation remains a counter-signal, so choosing enterprise workflow depth also means explaining why that direction deserves the next cycle now.",
        "A direction becomes coherent when its hypotheses reinforce one another. The target audience must experience the problem, the product must create distinct value, the advantage must be plausible, distribution must reach the audience, and the economics must support the work. Weakness in one link can invalidate the whole story. Noted may improve decision and owner follow-up yet still lack a repeatable route from an enthusiastic team lead to an authorized enterprise workspace.",
      ...
      exhibits: [
        {
          ...
          kind: "chain",
          items: [
            { kicker: "EVIDENCE", title: "Bounded belief", copy: "Unassigned action owners may cause repeated recap work in recurring decision-heavy enterprise meetings; causality and prevalence remain bounded." },
            { kicker: "TENSION", title: "What prevents progress", copy: "Teams lose decisions, action owners, or required context before follow-up, while enterprise governance slows adoption." },
            { kicker: "DIAGNOSIS", title: "Interpret the situation", copy: "The valuable wedge is reliably recording decisions and action owners, not producing more complete generic summaries." },
        ...
        },
        {
          ...
          items: [
            ...
            { kicker: "PROBLEM", title: "Decisions or owners are missing", copy: "Some teams reconstruct meeting outcomes later or miss assigned follow-up." },
            { kicker: "VALUE", title: "Retrievable decisions and owners", copy: "Keep each decision, action owner, and required context available during follow-up." },
      ...
      exhibits: [
        ...
        },
        {
          ...
          items: [
            ...
            { kicker: "WEEKS 2–4", title: "Test decision-and-owner capture", copy: "Ship explicit decision-and-owner capture to two design partners." },
  ...
  checkpointIntro: "The phase 3 record should make one strategic direction portable from product logic through allocation and technical ownership.",
  checkpointFields: [
  ...
  next: { label: "PHASE 4 · COMMIT + LEARN", title: "Make the choice survivable", copy: "Carry the direction through commitment, execution change, exposure, and outcome without losing ownership or rewriting history." }
};
